            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12"> 
                  <div class="col-md-12">
                    <?php 
                      ...
                      $query = mysqli_query($koneksi, "SELECT * FROM alternatif WHERE id_sample='$username'");
                    ?>
                ...
                //---------------------Menyimpan tabel sample dalam array---------------------
                    $sql="SELECT * FROM alternatif where pegawai='$username'";
                    $hasil=mysqli_query($koneksi, $sql);
                    while($row=mysqli_fetch_assoc($hasil))
                        {
                ...
                //---------------------Menyimpan tabel pegawai dalam array---------------------        
                    $nama_pegawai=array();
                    $nilai_akhir=array();
                    $sql="SELECT * FROM pegawai where id_pegawai='$username'";
                    $hasil=mysqli_query($koneksi, $sql);
                    while($row=mysqli_fetch_assoc($hasil))
                        {
