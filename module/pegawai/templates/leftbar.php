    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li>
         ...
         <li <?php if ($_GET["module"] == 'profile'){echo 'class="active"'; }?>>
          <a href="?module=profile">
            <i class="fa fa-trophy"></i> <span>Data Pegawai</span>            
          </a>
        </li> 
        <li <?php if ($_GET["module"] == 'profile_syarat'){echo 'class="active"'; }?>>
          <a href="?module=profile_syarat">
            <i class="fa fa-trophy"></i> <span>Profil Syarat</span>            
          </a>
        </li>     
        <li <?php if ($_GET["module"] == 'hasil'){echo 'class="active"'; }?>>
          <a href="?module=hasil">
