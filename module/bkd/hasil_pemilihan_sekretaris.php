<?php include 'module/koneksi.php'; ?>
  ...
  <?php
        ...
        //---------------------Menyimpan tabel pegawai dalam array---------------------        
            $nama_pegawai=array();
            $nilai_akhir=array();
            $sql="SELECT pegawai.*, pangkat_pendidikan.* FROM pegawai JOIN pangkat_pendidikan ON pegawai.id_pegawai = pangkat_pendidikan.id_pegawai where pangkat_pendidikan.pangkat >= 41 AND pangkat_pendidikan.pendidikan >= 4 AND pegawai.status ='sudah' ORDER BY pegawai.id_pegawai";            
            $hasil=mysqli_query($koneksi, $sql);
            while($row=mysqli_fetch_assoc($hasil))
                {
    ...
    ?>
        ...
        ?>
             ...
             ?>
                         ...
                         <center><span style="color: #3c8dbc;"><h3><b>Nilai Akhir Pegawai</b></h3></span></center>
