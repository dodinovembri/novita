        ...
        <div class="col-md-12">
          <div class="box">
           <!--  <div class="box-header with-border">
              <center><h3 class="box-title"><strong>Data Set Kriteria</strong></h3></center>
            </div> -->
           <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                	<a href="?module=tambah_data_kriteria"><button type="button" class="btn btn-warning">Tambah Data Kriteria</button></a><br>
                 <?php
                        include 'module/koneksi.php';
                        $sqlSelect = "SELECT kriteria.*, aspek.* FROM kriteria JOIN aspek ON kriteria.aspek=aspek.id_aspek";                        
                    ...
                    ?>                  
                            <tr>
                                ...
                                <td>
                                   <a href="?module=update_data_kriteria&id_kriteria=<?php echo $row['id_kriteria']; ?>"><button type="button" class="btn btn-warning">Update</button></a>
                                  <a href="?module=hapus_data_kriteria&id_kriteria=<?php echo $row['id_kriteria']; ?>"><button class="btn btn-danger" onclick="return konfirmasi()">Delete</button></a>
                                </td>
                            </tr>
                    <?php } ?>
                            </tbody>
