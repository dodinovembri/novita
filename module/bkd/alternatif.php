        ...
        <div class="col-md-12">
          <div class="box">
           <!--  <div class="box-header with-border">
              <center><h3 class="box-title"><strong>Data Set Alternatif</strong></h3></center>
            </div> -->
           <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                	<!-- <a href="?module=tambah_Altternatif"><button type="button" class="btn btn-warning">Tambah Data Alternatif</button></a><br> -->
                 <?php
                        include 'module/koneksi.php';
                        $sqlSelect = "SELECT * FROM pegawai WHERE `pangkat_golongan`>= 41 AND `pendidikan`>= 4 AND `status`='sudah'";                        
                    ...
                    ?>                  
                            <tr>
                                ...
                                <!-- <td>
                                  <a href="?module=update_data_jenis&id_jenis=<?php echo $row['id_jenis']; ?>"><button type="button" class="btn btn-warning">Update</button></a>
                                  <a href="?module=hapus_data_jenis&id_jenis=<?php echo $row['id_jenis']; ?>"><button class="btn btn-danger" onclick="return konfirmasi()">Delete</button></a>
                                </td> -->
                            </tr>
                    <?php } ?>
                            </tbody>
